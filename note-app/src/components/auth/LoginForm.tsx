...
import { signInWithCredentials, signInWithGoogle } from "@/lib/actions/user";
...
const LoginForm = () => {
    const {
        ...
        onSubmit,
    } = useAuthForm(signInWithCredentials);
        ...
        >
            ...
            >
                ...
                <motion.div
                    ...
                    className={`flex mb-[1.6rem] group hover:bg-customNeutral-50 hover:cursor-pointer border ${
                        errors.password
                            ? "border-customRed-500"
                            : "border-customNeutral-300"
                ...
                >
                    {pending ? <ClipLoader color="#fff" size={20} /> : "Login"}
                </motion.button>
            </form>
